    ...
    if (array_key_exists($id, $_SESSION['start']))
    {
        ...
        <form action="" method="post" class="col-sm-10" style="margin: 20px">
            ...
            <div class="form-group">
                ...
                <input class="form-control" value="<?php echo $_SESSION['start'][$id]['email']?>" type="text" name="email" placeholder="tên truy cập....">
            </div>

            <div class="form-group">
                <label for="">Password</label>
                <input class="form-control" value="<?php echo $_SESSION['start'][$id]['password']?>" type="text" name="password" placeholder="năm sinh....">
            </div>
